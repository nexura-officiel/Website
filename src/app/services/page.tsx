...
import { Monitor, Bot, Cloud, ArrowRight, Code, Database, Lock, Cpu, Globe, Zap, Briefcase, Stethoscope, Truck, ShoppingBag, Home, GraduationCap, Layers } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 gap-12">
            {t.services.items.map((service, index) => {
              const IconComponent = serviceIcons[index] || Monitor;
