                ...
                <form onSubmit={handleSubmit} className="lg:col-span-8 space-y-8">
                            ...
                            <div className="pt-6 border-t border-white/5">
                                ...
                                <div className="flex flex-wrap gap-2 mb-4 p-4 bg-black/20 rounded-xl border border-dashed border-white/10 min-h-[60px]">
                                    {formData.tags.map(tag => (
                                        <span key={tag} className="flex items-center gap-1.5 bg-cyan-500/10 text-cyan-400 px-3 py-1.5 rounded-lg text-xs border border-cyan-500/20 shadow-sm transition-all group hover:bg-cyan-500/20 font-bold uppercase tracking-tighter">
                                            {tag}
                    ...
                    <div className="flex items-center justify-end pt-4">
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex items-center gap-3 bg-cyan-500 hover:bg-cyan-400 disabled:bg-slate-700 text-midnight-navy font-black px-12 py-4 rounded-2xl transition-all shadow-xl hover:-translate-y-0.5"
                        >
                            <Save size={20} />
